...
def vgg16_score(input, numclass, workspace_default=1024):
    # region group 5: conv(512,3,3) - relu - conv(512,3,3) - relu - conv(512,3,3) - relu - pool
    # 1. conv
    ...
    pool5 = mx.symbol.Pooling(data=relu5_3, pool_type="max", kernel=(2, 2), pad=(1, 1), stride=(1, 1), name="pool5")
    # pool5 = relu5_3
    # endregion
...
def fcnxs_score(input, crop, offset,
                kernel=(64, 64),
                stride=(32, 32),
                numclass=21,
                workspace_default=1024):
    # score out
    bigscore = mx.symbol.Deconvolution(data=input, kernel=kernel,
                                       stride=stride,
    ...
    softmax = mx.symbol.SoftmaxOutput(
        data=upscore, multi_output=True,
        use_ignore=True,
        ignore_label=255,
        name="softmax"
    )
...
def fcnatrous_score(input, crop, offset,
                    kernel=(64, 64),
                    stride=(32, 32),
                    numclass=21,
                    workspace_default=1024):
    # ct_conv1_1 = mx.symbol.Convolution(data=input,
    #                                    kernel=(3, 3),
    #                                    num_filter=42,
    #                                    pad=(33, 33),
    #                                    workspace=workspace_default, name="ct_conv1_1")
    #
    # ct_relu1_1 = mx.symbol.Activation(data=ct_conv1_1, act_type="relu", name="ct_relu1_1")
    #
    # ct_conv1_2 = mx.symbol.Convolution(data=ct_relu1_1,
    #                                    kernel=(3, 3),
    #                                    num_filter=42,
    #                                    workspace=workspace_default, name="ct_conv1_2")
    #
    # ct_relu1_2 = mx.symbol.Activation(data=ct_conv1_2, act_type="relu", name="ct_relu1_2")
    #
    # ct_conv2_1 = mx.symbol.Convolution(data=ct_relu1_2,
    #                                    kernel=(3, 3),
    #                                    num_filter=84, dilate=(2, 2),
    #                                    # pad=(33,33),
    #                                    workspace=workspace_default, name="ct_conv2_1")
    #
    # ct_relu2_1 = mx.symbol.Activation(data=ct_conv2_1, act_type="relu", name="ct_relu2_1")
    #
    # ct_conv3_1 = mx.symbol.Convolution(data=ct_relu2_1,
    #                                    kernel=(3, 3),
    #                                    num_filter=168, dilate=(4, 4),
    #                                    workspace=workspace_default, name="ct_conv3_1")
    #
    # ct_relu3_1 = mx.symbol.Activation(data=ct_conv3_1, act_type="relu", name="ct_relu3_1")
    #
    # ct_conv4_1 = mx.symbol.Convolution(data=ct_relu3_1,
    #                                    kernel=(3, 3),
    #                                    num_filter=336, dilate=(8, 8),
    #                                    workspace=workspace_default, name="ct_conv4_1")
    #
    # ct_relu4_1 = mx.symbol.Activation(data=ct_conv4_1, act_type="relu", name="ct_relu4_1")
    #
    # ct_conv5_1 = mx.symbol.Convolution(data=ct_relu4_1,
    #                                    kernel=(3, 3),
    #                                    num_filter=672, dilate=(16, 16),
    #                                    workspace=workspace_default, name="ct_conv5_1")
    #
    # ct_relu5_1 = mx.symbol.Activation(data=ct_conv5_1, act_type="relu", name="ct_relu5_1")
    #
    # ct_fc1 = mx.symbol.Convolution(data=ct_relu5_1,
    #                                kernel=(3, 3),
    #                                num_filter=672,
    #                                workspace=workspace_default, name="ct_fc1")
    #
    # ct_fc1_relu = mx.symbol.Activation(data=ct_fc1, act_type="relu", name="ct_fc1_relu")
    #
    # ct_final = mx.symbol.Convolution(data=ct_fc1_relu,
    #                                  kernel=(1, 1),
    #                                  num_filter=numclass,
    #                                  workspace=workspace_default, name="ct_final")
    # score out
    bigscore = mx.symbol.Deconvolution(data=input, kernel=kernel,
                                       stride=stride,
                                       adj=(stride[0] - 1, stride[1] - 1),
...
def get_fcnatrous_symbol(numclass=21, workspace_default=1024):
    data = mx.symbol.Variable(name="data")
    pool3, pool2 = vgg16_pool3(data, workspace_default)
    pool4 = vgg16_pool4(pool3, workspace_default)
    # batch, numclass, w, h
    score = vgg16_score(pool4, numclass, workspace_default)
    softmax = fcnatrous_score(
        score,
        data,
        offset()["fcn32s_upscore"],
        (64, 64),
...
def get_fcn16s_symbol(numclass=21, workspace_default=1024):
    ...
    softmax = fcnxs_score(score_fused,
                          data,
                          offset()["fcn16s_upscore"],
                          (32, 32),
                          (16, 16),
                          numclass,
                          workspace_default
